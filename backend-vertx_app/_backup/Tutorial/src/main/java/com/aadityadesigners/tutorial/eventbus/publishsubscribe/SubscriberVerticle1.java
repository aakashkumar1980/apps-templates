...
public class SubscriberVerticle1 extends AbstractVerticle {
    private static final Logger LOGGER = LoggerFactory.getLogger(SubscriberVerticle1.class);

    @Override
    public void start(Promise<Void> startPromise) throws Exception {
        LOGGER.debug(String.format("%s::verticle started...", SubscriberVerticle1.class.getSimpleName()));
