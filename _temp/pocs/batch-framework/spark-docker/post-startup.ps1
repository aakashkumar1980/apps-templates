...
docker exec spark-docker-spark-master-1 /bin/bash -c "spark-submit --master spark://spark-master:7077 --conf spark.executorEnv.PYSPARK_PYTHON=/opt/bitnami/spark /var/poc-workspace/downloads3files.py"
